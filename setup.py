...
The optional local wake word ("Hey Luna") is NOT installed here — it's a
...
def main() -> None:
    print(f"⚙  LUNA Assistant setup — detected OS: {OS or 'unknown'}")
    ...
    print("   3) (Optional) Enable 'Hey Luna' from ⚙ → WAKE WORD.")
